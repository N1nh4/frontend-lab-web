...
export default function TermosDeUso() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 text-justify">
      ...
      <p className="mb-4">
        Ao criar uma conta ou utilizar esta plataforma, você concorda com estes Termos de Uso e com a nossa {' '}
         <a href="/politica-de-privacidade" className="underline text-green-900">Política de privacidade</a>, 
      ...
      <p className="mb-4">
        Para dúvidas ou sugestões, entre em contato pelo email: [PRECISAMOS ADC UM EMAIL]
      </p>
    </div>
  );
}