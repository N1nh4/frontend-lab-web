...
import { Bell, Clock, MapPinHouse, Phone, User, Users } from "lucide-react";
...
export default function RegistrarLotacaoPage() {
    ...
    const [statusSelecionado, setStatusSelecionado] = useState('SEM_INFORMACAO');
                ...
                <div className="flex h-8/12 justify-between">
                    ...
                    <div className="flex h-full">
                        <div className="flex flex-col justify-center py-8 gap-2 text-xl">
                            ...
                            <span className="flex items-center italic text-verdeEscuro">
                                <span>Ative as notificações dessa unidade</span>
                                <Bell className="ml-2" size={24} />
                            </span>
                            <span className="flex items-center">
                                <MapPinHouse className="mr-2" /> Endereço: {unidade.endereco.bairro.nome} - {unidade.endereco.rua}
                            </span>
                            <span className="flex items-center">
                                <Phone className="mr-2" /> Telefone: {unidade.telefone}
                            </span>
                            <span className="flex items-center font-bold">
                                <Users className="mr-2" /> Status: {unidade.status.split("_").join(" ")}
                            </span>
                            <span className="italic flex items-center">
                                <Clock className="mr-2" /> {unidade.ultimaAtualizacao}
                            </span>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col bg-verdePastel shadow-md rounded-2xl mr-10 m-4 max-h-80">
                            ...
                            <div className="flex flex-1 justify-center items-center">
                                <ul className="flex flex-col justify-center pl-5 p-4 gap-4 text-zinc-500 font-bold">
                                    ...
                                    <li className="flex items-center gap-2"><User stroke="#fe9a2e" /> MODERADO - quantidade moderada de pessoas.</li>
