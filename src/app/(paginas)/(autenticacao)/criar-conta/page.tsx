"use client";
import { criarUsuario } from '@/service/usuario';
    ...
    <div className="pt-0">
      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-900 to-emerald-700 flex items-center justify-center p-4 overflow-y-auto">
        ...
        <div className="relative z-10 bg-white p-8 rounded-lg shadow-xl w-full max-w-md text-center">
          <h1 className="text-4xl font-bold text-gray-800 mb-8 cursor-pointer">Cadastre-se</h1>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-700"
            ...
            {/* Botão Cadastrar */}
            <button 
              className="w-full cursor-pointer bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300"
              onClick={ criarConta }
            >
              Cadastrar
            </button>
            ...
            <p className="text-gray-600 mt-6 text-sm">
              Já possui conta?{' '}
              <a href="#" className="text-emerald-600 hover:underline font-semibold">Entre aqui</a>
            </p>
          </div>
        </div>
      </div>
